...
VMOP(MV,R03,R00,,) VMOP(MV,R03,R02,,) VMOP(MV,R03,R01,,) VMOP(MV,R03,R04,,) VMOP(MV,R03,R11,,)
VMOP(MV,R04,R00,,)
...
VMOP(MV,R10,R02,,) VMOP(MV,R10,R11,,) VMOP(MV,R10,R12,,) VMOP(MV,R10,R13,,)
VMOP(MV,R11,R00,,) VMOP(MV,R11,R01,,) VMOP(MV,R11,R10,,)
VMOP(MV,R12,R02,,) VMOP(MV,R12,R10,,)
...
VMOP(LD,R11,R00,I,) VMOP(LD,R11,R01,I,) VMOP(LD,R11,R02,I,) VMOP(LD,R11,R03,I,)
VMOP(LD,R12,R00,I,) VMOP(LD,R12,R01,I,)

VMOP(ST,R00,R01,I,) VMOP(ST,R00,R0C,I,) VMOP(ST,R00,R05,I,) VMOP(ST,R00,R0B,I,) VMOP(ST,R00,R1F,I,)
VMOP(ST,R01,R00,I,) VMOP(ST,R01,R02,I,)
...
VMOP(LSL,R02,,I,) VMOP(LSL,R10,,I,) VMOP(LSL,R11,,I,)

VMOP(LSR,R10,,I,)

VMOP(ADD,R00,R00,R01,) VMOP(ADD,R00,R00,R02,)
VMOP(ADD,R01,R01,R00,) VMOP(ADD,R01,R01,R02,)
VMOP(ADD,R02,R02,R00,) VMOP(ADD,R02,R02,R01,) VMOP(ADD,R02,R02,R03,)
VMOP(ADD,R03,R03,R02,)
VMOP(ADD,R10,R10,R00,) VMOP(ADD,R10,R10,R11,) VMOP(ADD,R10,R10,R13,)
VMOP(ADD,R11,R11,R00,) VMOP(ADD,R11,R11,R10,) VMOP(ADD,R11,R11,R12,)
VMOP(ADD,R12,R12,R00,) VMOP(ADD,R12,R12,R10,) VMOP(ADD,R12,R12,R11,)
VMOP(ADD,R13,R13,R00,) VMOP(ADD,R13,R13,R10,)
VMOP(ADD,R00,R00,I,) VMOP(ADD,R01,R01,I,) VMOP(ADD,R02,R02,I,) VMOP(ADD,R03,R03,I,)
VMOP(ADD,R10,R10,I,) VMOP(ADD,R11,R11,I,) VMOP(ADD,R12,R12,I,) VMOP(ADD,R1F,R1F,I,)

VMOP(MUL,R11,R11,R10,)
VMOP(MUL,R12,R12,R10,)
VMOP(MUL,R13,R13,R10,)
VMOP(MUL,R14,R14,R10,)
...
VMOP(BLT,R01,,I,O) VMOP(BLT,R10,,I,O)
