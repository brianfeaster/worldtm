...
VMOP(ADD,R03,R02,,)
VMOP(ADD,R10,R00,,) VMOP(ADD,R10,R11,,) VMOP(ADD,R10,R13,,)
VMOP(ADD,R11,R00,,) VMOP(ADD,R11,R10,,) VMOP(ADD,R11,R12,,)
VMOP(ADD,R12,R00,,) VMOP(ADD,R12,R10,,) VMOP(ADD,R12,R11,,)
